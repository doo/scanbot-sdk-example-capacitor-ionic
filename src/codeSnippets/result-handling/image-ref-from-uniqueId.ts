import { autorelease, DeepPartial, ImageRef } from 'capacitor-plugin-scanbot-sdk';

async function createImageRefFromSerializedReference(serializedReference: DeepPartial<ImageRef>) {
  /*
