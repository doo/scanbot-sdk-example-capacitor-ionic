...
async function startScanning() {
  try {
    ...
    configuration.mrzExampleOverlay.mrzTextLine1 = 'I<USA2342353464<<<<<<<<<<<<<<<';
    configuration.mrzExampleOverlay.mrzTextLine2 = '9602300M2904076USA<<<<<<<<<<<2';
    configuration.mrzExampleOverlay.mrzTextLine3 = 'SMITH<<JACK<<<<<<<<<<<<<<<<<<<';
