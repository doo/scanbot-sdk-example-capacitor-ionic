...
async function startScanning() {
  try {
    ...
    acknowledgementScreenConfig.bottomBar.acceptWhenAcceptableButton.title.visible = false;
    acknowledgementScreenConfig.bottomBar.proceedAnywayButton.unacceptableQuality.title.visible = false;
    acknowledgementScreenConfig.bottomBar.proceedAnywayButton.documentNotFound.title.visible = false;
    acknowledgementScreenConfig.bottomBar.proceedAnywayButton.uncertainQuality.title.visible = false;
